                  ...
                  return (
                    <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 4, height: CHART_H + 36, padding: '0 4px' }}>
                      {bars.map(d => {
                        ...
                        return (
                          <div key={d.date} style={{ flex: 1, maxWidth: 36, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3, height: '100%', justifyContent: 'flex-end' }}>
                            <span style={{ fontSize: 8, color: 'var(--gray-400)', fontVariantNumeric: 'tabular-nums', whiteSpace: 'nowrap' }}>
                              {formatCost(d.cost_millicents)}
                            </span>
                            <div style={{ width: '60%', height: barH, background: 'var(--brand)', borderRadius: '3px 3px 0 0' }} />
